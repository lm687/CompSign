...
<<>>=
# data("Breast560")
dim(metadata(Breast560))
dim(count_matrix(Breast560))
@
...
Samples can simply be clustered by the cosine similarity of their exposures
<<>>=
WrapperlikeFunctions_copy.R

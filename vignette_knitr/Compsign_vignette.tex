...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Skipping install of 'CompSign' from a github remote, the SHA1 (723e4ee3) has not changed since last install.\\\#\# \ \ Use `force = TRUE` to force installation}}\end{kframe}
\end{knitrout}

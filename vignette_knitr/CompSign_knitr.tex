...
## -1.8528 -0.5506  0.1283  0.4883  2.3322 
## 
## Coefficients: (1 not defined because of singularities)
##                                           Estimate Std. Error t value
## (Intercept)                             -5.910e-02  3.650e-01  -0.162
## as.matrix((x@df)[, indices_predictor])a  8.259e-05  6.782e-05   1.218
## as.matrix((x@df)[, indices_predictor])b         NA         NA      NA
##                                         Pr(>|t|)
## (Intercept)                                0.873
## as.matrix((x@df)[, indices_predictor])a    0.233
## as.matrix((x@df)[, indices_predictor])b       NA
## 
## Residual standard error: 0.9454 on 28 degrees of freedom
## Multiple R-squared:  0.05029,	Adjusted R-squared:  0.01638 
## F-statistic: 1.483 on 1 and 28 DF,  p-value: 0.2335
## 
## 
## Response Y2 :
## 
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.2867 -0.5890  0.1019  0.6377  1.7267 
## 
## Coefficients: (1 not defined because of singularities)
##                                           Estimate Std. Error t value
## (Intercept)                              4.849e-01  5.049e-01    0.96
## as.matrix((x@df)[, indices_predictor])a -6.093e-05  9.381e-05   -0.65
## as.matrix((x@df)[, indices_predictor])b         NA         NA      NA
##                                         Pr(>|t|)
## (Intercept)                                0.345
## as.matrix((x@df)[, indices_predictor])a    0.521
## as.matrix((x@df)[, indices_predictor])b       NA
## 
## Residual standard error: 1.308 on 28 degrees of freedom
## Multiple R-squared:  0.01484,	Adjusted R-squared:  -0.02034 
## F-statistic: 0.4219 on 1 and 28 DF,  p-value: 0.5213
## 
## 
## Response Y3 :
## 
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.6712 -0.9675  0.3252  0.7976  1.7726 
## 
## Coefficients: (1 not defined because of singularities)
##                                           Estimate Std. Error t value
## (Intercept)                             -2.961e-01  4.993e-01  -0.593
## as.matrix((x@df)[, indices_predictor])a  1.309e-05  9.277e-05   0.141
## as.matrix((x@df)[, indices_predictor])b         NA         NA      NA
##                                         Pr(>|t|)
## (Intercept)                                0.558
## as.matrix((x@df)[, indices_predictor])a    0.889
## as.matrix((x@df)[, indices_predictor])b       NA
## 
## Residual standard error: 1.293 on 28 degrees of freedom
## Multiple R-squared:  0.0007105,	Adjusted R-squared:  -0.03498 
## F-statistic: 0.01991 on 1 and 28 DF,  p-value: 0.8888
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -2.9889  -0.2887  -0.1244   0.3399   2.9367  
## 
## Coefficients:
##                                                       Estimate Std. Error
## (Intercept)                                          0.2291758  0.3007235
## ilr(acomp(count_matrix(two_normal_pops_extended)))1  2.1790481  0.0832272
## ilr(acomp(count_matrix(two_normal_pops_extended)))2 -0.0531453  0.2065535
## ilr(acomp(count_matrix(two_normal_pops_extended)))3 -0.0001603  0.1363011
## ilr(acomp(count_matrix(two_normal_pops_extended)))4 -0.1059098  0.1210142
## ilr(acomp(count_matrix(two_normal_pops_extended)))5 -0.2222432  0.1115794
## ilr(acomp(count_matrix(two_normal_pops_extended)))6 -0.1488437  0.1008784
## ilr(acomp(count_matrix(two_normal_pops_extended)))7 -0.0337739  0.1002323
##                                                     z value Pr(>|z|)    
## (Intercept)                                           0.762   0.4460    
## ilr(acomp(count_matrix(two_normal_pops_extended)))1  26.182   <2e-16 ***
## ilr(acomp(count_matrix(two_normal_pops_extended)))2  -0.257   0.7970    
## ilr(acomp(count_matrix(two_normal_pops_extended)))3  -0.001   0.9991    
## ilr(acomp(count_matrix(two_normal_pops_extended)))4  -0.875   0.3815    
## ilr(acomp(count_matrix(two_normal_pops_extended)))5  -1.992   0.0464 *  
## ilr(acomp(count_matrix(two_normal_pops_extended)))6  -1.475   0.1401    
## ilr(acomp(count_matrix(two_normal_pops_extended)))7  -0.337   0.7361    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for binomial family taken to be 1)
## 
##     Null deviance: 2772.1  on 1999  degrees of freedom
## Residual deviance:  826.7  on 1992  degrees of freedom
## AIC: 842.7
## 
...
## $coefTransformed
## (Intercept)          X1          X2          X3 
##   0.1367010  -7.3280799   7.7678830  -0.3031021 
## 
## $summary
## Call:
...
## Coefficients:
##                 Values Std. Err.
## (Intercept)  0.1367010 0.1342114
## X1          -7.3280799 0.4214446
## X2           7.7678830 0.3703522
## X3          -0.3031021 0.4312107
## 
## Residual Deviance: 894.3572 
## AIC: 900.3572 
## 
## $res
## Call:
...
## initial  value 1386.294361 
## iter  10 value 432.901441
## final  value 432.900948 
## converged
\end{verbatim}
\begin{alltt}
\hlstd{resB}
...
##   0.03334086 -15.95577196  15.62501953   0.34742286   1.25056827 
##           X5           X6           X7           X8 
##  -0.54866982  -0.77879194  -0.29782226   0.39138617 
## 
## $summary
## Call:
## multinom(formula = as.formula(frm), data = dat)
...
## Coefficients:
##                   Values Std. Err.
## (Intercept)   0.03334086 0.1637080
## X1          -15.95577196 0.8575790
## X2           15.62501953 0.7090152
## X3            0.34742286 0.9196285
## X4            1.25056827 0.9247634
## X5           -0.54866982 0.8987120
## X6           -0.77879194 0.8939545
## X7           -0.29782226 0.9351710
## X8            0.39138617 0.8886918
## 
## Residual Deviance: 865.8019 
## AIC: 879.8019 
## 
## $res
## Call:
...
\begin{verbatim}
## (Intercept)          X1          X2          X3 
##   0.3084170   0.0000000   0.0000000   0.4821121
\end{verbatim}
\begin{alltt}
...
##   0.8386188   0.0000000   0.0000000   0.7055895   0.1762757   0.5415261 
##          X6          X7          X8 
##   0.3836579   0.7501298   0.6596423
\end{verbatim}
\begin{alltt}

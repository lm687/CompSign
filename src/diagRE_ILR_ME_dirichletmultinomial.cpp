// Using the ILR transformation instead of the ALR (i.e. transforming back the coefficients using the inverse ILR and not the softmax)

#include <TMB.hpp>
#include "functions.hpp"
#include "/Users/lenamorrill/Software/coda.base/src/coda.cpp"
#include "/Users/lenamorrill/Software/coda.base/src/coda.hpp"

// need to export path for coda /Users/lenamorrill/Software/coda.base/src/
...
Type objective_function<Type>::operator() ()
{
  ...
  for(int l=0;l<n;l++){
    theta.row(l) = inv_ilr_coordinates(theta_prime(l,j)); // inverse ILR transformation
  }
